...
const Projects = () => {
    return (
        <>
            <p>Hello, I'm Filippo, a passionate Web Developer. With a background in culinary arts and a knack for crafting the perfect pizza, I've ventured into the world of web development to create digital experiences that are just as satisfying.</p>

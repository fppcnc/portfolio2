...
const abooz = 'About'
    return (
        <>
            <p>Hello, I'm Filippo, a passionate Pizza Maker turned Web Developer. With a background in culinary arts and a knack for crafting the perfect pizza, I've ventured into the world of web development to create digital experiences that are just as satisfying.</p>
            <p>I bring a unique blend of skills to the table. My journey began in the in Italy, where I discovered at a young age my love for baking and crafting ever-appealing pizzas. From kneading dough in Italy to perfecting the art of pizza-making in the vibrant food scene of Melbourne, Australia, my culinary skills evolved across continents. My quest for excellence led me to Berlin, Germany, where I embarked on a new chapter of growth. I started my Umschulung FIAE, a transformative journey of transitioning from pizza ovens to coding terminals. As I continue this educational path, my passion for learning remains as fresh as a just-baked pizza.</p>
